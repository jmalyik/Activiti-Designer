...
public class ActivitiDiagramEditor extends DiagramEditor {
  ...
  private void marshallImage(BpmnMemoryModel model, String modelFileName) {
    try {
      final GraphicalViewer graphicalViewer = (GraphicalViewer) ((DiagramBehavior) model.getFeatureProvider()
    		  .getDiagramTypeProvider().getDiagramBehavior()).getAdapter(GraphicalViewer.class);
